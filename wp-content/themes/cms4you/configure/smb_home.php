...
function landing_block() {
    ...
    $theam_meta->add_field( array(
        'name' => 'Настройки секции about-content',
        'type' => 'title1',
        'id'   => 'aboutContent_title'
    ) );
    ...
    $theam_meta->add_field( array(
        'name'    => 'О клинике: Текст 1',
        'default' => 'Уникальное медицинское учреждение в Москве, которое подходит к организму человека как к целостной живой системе. <br>Здесь работают высококвалифицированные врачи, кандидаты и доктора наук, имеющие многолетний опыт медицинской практики.',
        'id'      => 'aboutContent_p1',
        'type'    => 'text',
    ) );
    $theam_meta->add_field( array(
        'name'    => 'О клинике: Текст 2',
        'default' => 'Клиника предлагает комплексное решение медицинских проблем пациента и индивидуальный подход к каждому человеку. Врачи выявляют и воздействуют на скрытые нарушения в организме, являющиеся истинной причиной всех симптомов и жалоб пациента. В клинике используются глубокое знание основ медицины и системный подход для устранения причин плохого самочувствия и приведения организма в порядок.',
        'id'      => 'aboutContent_p2',
        'type'    => 'text',
    ) );
    $theam_meta->add_field( array(
