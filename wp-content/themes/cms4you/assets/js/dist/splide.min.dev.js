...
!function () {
  ...
  var U = function () {
    ...
    return u.mount = function (t, n) {
      ...
      return void 0 === e && (e = null), void 0 === i && (i = {
        passive: !0
      }), this.Event.on(t, n, e, i), this;
    }, u.off = function (t, n) {
  ...
  var rt = function rt(t, n) {
    ...
    function d(n) {
      return y('<button class="' + s.arrow + " " + (n ? s.prev : s.next) + '" type="button"><svg xmlns="http://www.w3.org/2000/svg"\tviewBox="0 0 20 20"\twidth="20"\theight="20"><path d="' + (t.options.arrowPath || "M7.5 3.75L13.75 10L7.5 16.25") + '" />');
    }
